...
<style>
    ...
    .status-archived { background-color: #fca311; color: #333; }   
    .status-deleted { background-color: #ff6b6b; color: white; }    
...
<div class="post-container">
    ...
    <form action="{{ route('post.search') }}" method="GET" style="display: flex; gap: 10px;">
        <input type="search" name="param" placeholder="Search dispatches..." aria-label="Search" value="{{ request('param') }}" 
